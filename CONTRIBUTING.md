...
You should learn how `searchIterator` works before continuing: [Read on Documentation Site](http://differentia.io/?p=searchIterator%2Fsearch-algorithm-iterators.md)
